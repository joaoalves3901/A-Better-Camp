...
INSERT INTO centro_saude (nome,centro_tlm,centro_morada, coords) VALUES ('USF Cais do Sodré',213405550,'Tv. Ribeira Nova 1', ST_GeomFromText('POINT(38.70725188152147 -9.145017836093594)', 4326));
INSERT INTO centro_saude (nome,centro_tlm,centro_morada, coords) VALUES ('USF Areeiro',218471406,'Av. Afonso Costa 41', ST_GeomFromText('POINT(38.739812839502854 -9.126703363148232)', 4326));
INSERT INTO centro_saude (nome,centro_tlm,centro_morada, coords) VALUES ('USF Rio de Mouro',219178110,'Av. Infante Dom Henrique 39', ST_GeomFromText('POINT(38.78756034338976 -9.326965509159997)', 4326));
INSERT INTO centro_saude (nome,centro_tlm,centro_morada, coords) VALUES ('USF Reynaldo dos Santos',219540114,'Av. D. Vicente Afonso Valente r/c', ST_GeomFromText('POINT(38.86236494583346 -9.068034986138166)', 4326));
INSERT INTO centro_saude (nome,centro_tlm,centro_morada, coords) VALUES ('USF Martin Moniz',218843000,'Praça Martim Moniz 43B', ST_GeomFromText('POINT(38.71620952837133 -9.13686056020565)', 4326));
INSERT INTO centro_saude (nome,centro_tlm,centro_morada, coords) VALUES ('USF Arco',213947310,'Travessa do Noronha 5A', ST_GeomFromText('POINT(38.717831371766316 -9.152927897789972)', 4326));
